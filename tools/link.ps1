...
# One folder is the whole mod: code at the top level, the data mod under Data\ (registered by the code at startup).
# Do NOT also link anything into <game>\Mods, or the data would be loaded twice.
$links = @(
